$(function() {
	...
	var opts = {
		...
		grains: [
			...
			{ name: 'Belgian Caramunich', color: '#94622f' },
			{ name: 'Belgian Caravienne', color: '#f6d564' },
			{ name: 'Belgian Debittered Black Malt', color: '#603829' },
			{ name: 'Belgian Pale Ale', color: '#cfb586' },
			...
			{ name: 'Briess Caramel 10L', color: '#cfb586' },
			{ name: 'Briess Caramel 120L', color: '#603829' },
			...
			{ name: 'Briess Caramel 90L', color: '#94622f' },
			...
			{ name: 'Briess Organic Chocolate', color: '#603829' },
			...
			{ name: 'English Black Malt', color: '#603829' },
			{ name: 'English Brown Malt', color: '#2d1a05' },
			{ name: 'English Chocolate Malt', color: '#603829' },
			{ name: 'English Dark Crystal', color: '#712300' },
			{ name: 'English Extra Dark Crystal', color: '#603829' },
			...
			{ name: 'Fawcett Pale Chocolate', color: '#603829' },
			{ name: 'Flaked Barley', color: '#cfb586' },
			{ name: 'Flaked Maize', color: '#cfb586' },
			{ name: 'Flaked Oats', color: '#ffb94b' },
			{ name: 'Flaked Rye', color: '#cfb586' },
			{ name: 'Flaked Wheat', color: '#cfb586' },
			{ name: 'Francobelges Kiln Coffee', color: '#603829' },
			...
			{ name: 'Weyermann® CaraRed®', color: '#943722' },
			{ name: 'Weyermann® Carawheat®', color: '#db972c' },
			{ name: 'Weyermann® Chocolate Rye Malt', color: '#603829' },
			...
			{ name: 'Weyermann® Dehusked Carafa® III', color: '#94622f' },
			{ name: 'Weyermann® Floor Malted Bohemian Dark Malt', color: '#603829' },
